...
// ---- INTERNAL COMPONENTS ----
// These are kept here as they are only used by this dashboard page.
...
export default function RegionalAdminDashboard() {
  ...
  const handleAction = (action, type, idx) => {
    alert(`${action} ${type === TABS.HOTELS ? "Hotel" : "Police Station"}: ${type === TABS.HOTELS ? HOTEL_DATA[idx].name : POLICE_DATA[idx].name}`);
  };
