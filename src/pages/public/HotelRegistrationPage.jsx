    ...
    <div className="font-poppins bg-gray-50 min-h-screen">
      <header className="bg-white shadow-sm">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <Link to="/" className="text-2xl font-bold text-gray-800">ApnaManager</Link>
        </nav>
      </header>
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <fieldset className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <FileInputField label="Shop Owner Signature" name="ownerSignature" file={files.ownerSignature} onChange={handleFileChange} />
                 <FileInputField label="Hotel Stamp / Shop Mohar" name="hotelStamp" file={files.hotelStamp} onChange={handleFileChange} />
               </div>
            </fieldset>
